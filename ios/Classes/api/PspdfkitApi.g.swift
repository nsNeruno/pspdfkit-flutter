...
class PspdfkitApiSetup {
    ...
    static func setUp(binaryMessenger: FlutterBinaryMessenger, api: PspdfkitApi?, messageChannelSuffix: String = "") {
        let channelPrefix = "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitApi"
...
class PspdfkitWidgetControllerApiSetup {
    ...
    static func setUp(binaryMessenger: FlutterBinaryMessenger, api: PspdfkitWidgetControllerApi?, messageChannelSuffix: String = "") {
        let channelPrefix = "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi"
        ...
        // MARK: Custom Methods
        let canUndoChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).canUndo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let undoChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).undo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let getAnnotationStateChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).getAnnotationState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let toggleInkAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleInkAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleInkAnnotationChannel.setMessageHandler { message, reply in
                api.toggleInkAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleInkHighlightAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleInkHighlightAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleInkHighlightAnnotationChannel.setMessageHandler { message, reply in
                api.toggleInkHighlightAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleLineAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleLineAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleLineAnnotationChannel.setMessageHandler { message, reply in
                api.toggleLineAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleArrowAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleArrowAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleArrowAnnotationChannel.setMessageHandler { message, reply in
                api.toggleArrowAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleSquareAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleSquareAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleSquareAnnotationChannel.setMessageHandler { message, reply in
                api.toggleSquareAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleCircleAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleCircleAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleCircleAnnotationChannel.setMessageHandler { message, reply in
                api.toggleCircleAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleCloudAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleCloudAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleCloudAnnotationChannel.setMessageHandler { message, reply in
                api.toggleCloudAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleCalloutAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleCalloutAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleCalloutAnnotationChannel.setMessageHandler { message, reply in
                api.toggleCalloutAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {
        ...
        let toggleFreeTextAnnotationChannel = FlutterBasicMessageChannel(name: "\(channelPrefix).toggleFreeTextAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            toggleFreeTextAnnotationChannel.setMessageHandler { message, reply in
                api.toggleFreeTextAnnotation(completion: { res in
                    reply(wrapResult(nil))
                })
            }
        } else {

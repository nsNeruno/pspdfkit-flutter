...
protocol PspdfkitWidgetControllerApi {
  ...
  func canUndo(completion: @escaping (Result<Bool, Error>) -> Void)
  func undo(completion: @escaping (Result<Bool, Error>) -> Void)
  func canRedo(completion: @escaping (Result<Bool, Error>) -> Void)
  func redo(completion: @escaping (Result<Bool, Error>) -> Void)
  func getAnnotationState(completion: @escaping (Result<[String: Any?]?, Error>) -> Void)
...
class PspdfkitWidgetControllerApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: PspdfkitWidgetControllerApi?, messageChannelSuffix: String = "") {
    ...
    let canUndoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.canUndo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      canUndoChannel.setMessageHandler { _, reply in
        api.canUndo { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      canUndoChannel.setMessageHandler(nil)
    }
    let undoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.undo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let canRedoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.canRedo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      canRedoChannel.setMessageHandler { _, reply in
        api.canRedo { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      canRedoChannel.setMessageHandler(nil)
    }
    let redoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.redo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getAnnotationStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.getAnnotationState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getAnnotationStateChannel.setMessageHandler { _, reply in
        api.getAnnotationState { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getAnnotationStateChannel.setMessageHandler(nil)
    }
    let toggleInkAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleInkAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleInkAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleInkAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleInkAnnotationChannel.setMessageHandler(nil)
    }
    let toggleInkHighlightAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleInkHighlightAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleInkHighlightAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleInkHighlightAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleInkHighlightAnnotationChannel.setMessageHandler(nil)
    }
    let toggleLineAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleLineAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleLineAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleLineAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleLineAnnotationChannel.setMessageHandler(nil)
    }
    let toggleArrowAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleArrowAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleArrowAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleArrowAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleArrowAnnotationChannel.setMessageHandler(nil)
    }
    let toggleSquareAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleSquareAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleSquareAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleSquareAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleSquareAnnotationChannel.setMessageHandler(nil)
    }
    let toggleCircleAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleCircleAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleCircleAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleCircleAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleCircleAnnotationChannel.setMessageHandler(nil)
    }
    let toggleCloudAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleCloudAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleCloudAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleCloudAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleCloudAnnotationChannel.setMessageHandler(nil)
    }
    let toggleCalloutAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleCalloutAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleCalloutAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleCalloutAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleCalloutAnnotationChannel.setMessageHandler(nil)
    }
    let toggleFreeTextAnnotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pspdfkit_flutter.PspdfkitWidgetControllerApi.toggleFreeTextAnnotation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      toggleFreeTextAnnotationChannel.setMessageHandler { _, reply in
        do {
          try api.toggleFreeTextAnnotation()
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      toggleFreeTextAnnotationChannel.setMessageHandler(nil)
    }
  }
}
/// Generated protocol from Pigeon that represents a handler of messages from Flutter.
